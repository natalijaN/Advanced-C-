...
namespace CSharpAdvanced_Class4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Price with discount: {m1.GetPriceWithDiscount()}");
            Console.WriteLine($"Full price: {m1.Price.WithCurrency("EUR")}");
            Console.WriteLine("Discount price: {0}", m1.GetPriceWithDiscount().WithCurrency("EUR"));
            Console.WriteLine("--------------------");
            #endregion
            ...
            Console.WriteLine($"Price with discount: {m2.GetPriceWithDiscount()}");
            Console.WriteLine($"Full price: {m2.Price.WithCurrency("EUR")}");
            Console.WriteLine("Discount price: {0}", m2.GetPriceWithDiscount().WithCurrency("EUR"));
            Console.WriteLine("--------------------");
            #endregion
            ...
            Console.WriteLine($"Price with discount: {pc1.GetPriceWithDiscount()}");

            Console.WriteLine($"Price with currency: {pc1.Price.WithCurrency("EUR")}");            
            Console.WriteLine($"Discount price: {pc1.GetPriceWithDiscount().WithCurrency("EUR") }");

            Console.WriteLine("--------------------");

            pc1.Quantity = 2;
            Console.WriteLine($"Price for two {pc1.Name}: {pc1.GetTotalPrice().WithCurrency("EUR")}");
            #endregion
        }
    }
}
